...
- Target Kotlin 2.0.20 / JVM 17, built via Gradle Kotlin DSL (`app/build.gradle.kts`).
- Format/lint with `ktlint` (`./gradlew ktlintCheck`, `./gradlew ktlintFormat`) and Android Lint (`./gradlew lint`).
